...
class InstallController extends Controller
{
    ...
    public function siteInfo(Request $request)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            $rules = array_merge($rules, $mail_rules[$request->mail_driver]);
    ...
    public function import(Request $request)
    {
        ...
        // mail setting
        \Acelle\Model\Setting::set('mailer.driver', $site_info['mail_driver']);
    ...
    public function checkSystemCompatibility()
    {
        return [
            [
                'type' => 'requirement',
                'name' => 'PHP version',
                'check' => version_compare(PHP_VERSION, '7.1.3', '>='),
                'note' => 'PHP 7.1.3 or higher is required.',
            ],
            [
                'type' => 'requirement',
